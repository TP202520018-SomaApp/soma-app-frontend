...
import subject from '../../../services/allergies/get.allergies.service.js';

test('get.allergies.service - default exists', () => {
  expect(subject).toBeDefined();
});
test('get.allergies.service - default resolves', async () => {
