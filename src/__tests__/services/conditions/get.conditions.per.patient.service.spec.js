...
import subject from '../../../services/conditions/get.conditions.per.patient.service.js';

test('get.conditions.per.patient.service - default exists', () => {
  expect(subject).toBeDefined();
});
test('get.conditions.per.patient.service - default resolves', async () => {
