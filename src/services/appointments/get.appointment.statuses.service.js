...
export default async function getAppointmentStatuses() {
    try {
        const response = await requester.get(`appointments/statuses`);
        ...
        return new Response(null,
            ...
            "Error interno del servidor al obtener los estados de citas"
