...
export default async function linkPatientToDoctor(patientId, doctorId) {
    try {
        const response = await requester.post(`doctors/${doctorId}/patients/${patientId}`);
        ...
        return new Response(null,
            ...
            "No se encontró al paciente o al médico"
