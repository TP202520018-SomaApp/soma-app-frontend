...
export default async function getNotificationSeverities() {
    try {
        const response = await requester.get('/notifications/severities');
        ...
        return new Response(null,
            ...
            "Error interno del servidor al obtener los tipos de notificaciones"
