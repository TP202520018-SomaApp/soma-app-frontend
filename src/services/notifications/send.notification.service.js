...
export default async function sendNotification(patientId, doctorId, notification) {
    try {
        const response = await requester.post(
            !doctorId?`patients/${patientId}/notifications/`:
            `doctors/${doctorId}/patients/${patientId}/notifications/`,
            notification);
        ...
        return new Response(null,
            ...
            "Error interno del servidor al enviar la notificación"
